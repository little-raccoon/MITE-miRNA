...
my $lst_file="/lustre1/leili_pkuhpc/guozhl/MITEs/PMITEdb/miRNA_conservation/species.txt";
...
foreach my $col_family(%total_family){
    print "$col_family";
    foreach my $row_family(sort keys %total_family){
        my $total_count=0;
        my $novel_count=0;
        my $novel_rate=0;
        ...
        my $novel_rate=$novel_count/$total_count;
        print "\t$novel_rate";
    }
    print "\n";
}
